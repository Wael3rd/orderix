        const GAME_MODES = {
            ...
            sortDesc: { name: "Tri DÃ©croissant", isSort: true, order: -1 },
            ...
            flashMax: { name: "MÃ©moire Flash Max", findTarget: 'max', flashHide: true },
            ...
            hideHover: { name: "FantÃ´mes", isSort: true, order: 1, cssClass: 'hide-until-hover' },
            ...
            median: { name: "La MÃ©diane", findTarget: 'median' },
            ...
            shrinkSort: { name: "RÃ©trÃ©cissement", isSort: true, order: 1, cssClass: 'shrink-anim' },
            ...
            blindSort: { name: "Tri Ã  l'aveugle", isSort: true, order: 1, peekHide: true },
            mathDiff: { name: "Soustraction Cible", isDiff: true },
            avoidMin: { name: "Survie (Ã‰viter Min)", avoidTarget: 'min' },
            pulseSort: { name: "Pulsation", isSort: true, order: 1, cssClass: 'pulse-anim' },
            wobbleMax: { name: "InstabilitÃ© Max", findTarget: 'max', cssClass: 'wobble-anim' },
            findTargetUI: { name: "Recherche Exacte", isTargetMatch: true },
            gravitySort: { name: "GravitÃ©", isSort: true, order: 1, cssClass: 'gravity-anim' },
            ...
            sequenceHunt: { name: "Chasse en SÃ©rie", isSequence: true, sequenceLength: 5 },
        ...
        // 50 Base Types
        const BASE_TYPES = [
            { id: 1,  title: "LuminositÃ©", type: "lightness" },
            { id: 2,  title: "Saturation", type: "saturation" },
            { id: 3,  title: "Teinte", type: "hue" },
            { id: 4,  title: "OpacitÃ©", type: "opacity" },
            ...
            { id: 16, title: "ThermomÃ¨tre", type: "thermometer" },
            ...
            { id: 50, title: "Ã‚ges de la vie", type: "ages" }
        ];
