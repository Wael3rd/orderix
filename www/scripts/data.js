...
const GAME_MODES = {
    ...
    cadenas: { rev: 1, name: "Le Cadenas", isCadenas: true, typeAgnostic: true, desc: "Faites tourner chaque molette (▲ / ▼) jusqu'à ce que la ligne du milieu affiche la suite dans l'ordre croissant, de gauche à droite." },
    memoCroissant: { rev: 1, name: "Mémo Croissant", isMemoCroissant: true, typeAgnostic: true, desc: "Retournez deux cartes à la fois pour retrouver les paires, dans l'ordre : d'abord la paire 1, puis la 2, puis la 3… La valeur recherchée est affichée en haut." },
    solitaire: { rev: 1, name: "Le Solitaire", isSolitaire: true, typeAgnostic: true, desc: "Un vrai solitaire, en petit : descendez les cartes en alternant les couleurs sur le tableau, retournez les cartes cachées, et montez les 1→12 aux deux fondations. Pioche recyclable, annulation illimitée." },
    blocs: { rev: 1, name: "Blocs", isBlocs: true, typeAgnostic: true, desc: "Posez les pièces sur la grille : chaque ligne ou colonne complète s'efface. Effacez 6 lignes sans saturer la grille !" },
    ...
    paires: { rev: 1, name: "Paires Reliées", isPaires: true, typeAgnostic: true, desc: "Reliez les deux tuiles de même numéro par un chemin d'au plus 2 virages — et dans l'ordre : les 1, puis les 2… Le tour du plateau compte comme passage." },
    tubes: { name: "Les Tubes", isTubes: true, typeAgnostic: true, desc: "Reversez les jetons pour reconstituer quatre piles parfaitement ordonnées. Annulation illimitée." },
    swapSort: { name: "Échange Minimal", isSwapSort: true, typeAgnostic: true, desc: "Triez la rangée en échangeant deux VOISINS à la fois — les échanges possibles s'illuminent. Budget limité !" },
    ...
    etageres: { name: "Les Étagères", isEtageres: true, typeAgnostic: true, desc: "Échangez les objets pour que chaque étagère porte sa suite complète, dans l'ordre. 14 échanges maximum." },
    ...
    chronologie: { rev: 1, name: "Chronologie", isChronologie: true, typeAgnostic: true, desc: "Ordonnez ces 5 réalités de la plus petite à la plus grande : dates, tailles, poids… 1 joker." },
    ...
    embouteillage: { rev: 1, name: "L'Embouteillage", isEmbouteillage: true, typeAgnostic: true, desc: "Faites glisser les véhicules dans leur axe pour ouvrir la voie : la voiture DORÉE doit atteindre la sortie à droite. Annulation illimitée." },
    ...
    filsEmmeles: { rev: 1, name: "Les Fils", isFilsEmmeles: true, typeAgnostic: true, desc: "Échangez deux pastilles à la fois pour dénouer tous les fils vers les prises 1 à 8. Zéro croisement = gagné !" },
    ...
    chemin: { rev: 1, name: "Le Chemin", isChemin: true, typeAgnostic: true, desc: "Traversez toute la grille case par case, en passant sur chaque jalon doré exactement au bon pas. Touchez votre dernière case pour reculer." },
    ...
    conveyorBelt: { rev: 1, name: "Tapis Roulant", isConveyor: true, avoidTypes: ['shadow', 'blur', 'opacity', 'radius', 'borderWidth'], desc: "Touchez en bas l'objet qui se présente dans le cadre doré." },
