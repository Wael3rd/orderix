...
const GAME_MODES = {
    ...
    fontaine: { name: "La Fontaine", isFontaine: true, typeAgnostic: true, desc: "Les bulles descendent : éclatez-les dans l'ordre croissant avant qu'elles ne touchent le fond. 3 vies." },
    metronome: { name: "Le Métronome", isMetronome: true, typeAgnostic: true, desc: "Touchez les nombres dans l'ordre croissant, en tenant le tempo qui accélère. 2 vies." },
    laSuite: { name: "La Suite", isLaSuite: true, typeAgnostic: true, desc: "Videz votre main sur les piles : montantes ↑ et descendantes ↓. Astuce : reculer d'exactement 10 est permis !" },
    patience: { name: "Patience", isPatience: true, typeAgnostic: true, desc: "Empilez le flux sur 4 colonnes toujours croissantes. 3 défausses maximum." },
    duel: { name: "Duel", isDuel: true, typeAgnostic: true, desc: "Posez ±1 sur les piles centrales plus vite que votre adversaire. Videz votre pioche la première !" },
    rummy: { name: "Suites", isRummy: true, typeAgnostic: true, desc: "Formez 3 suites de 3 nombres consécutifs depuis votre main. 2 vies." },
    dominoOrder: { name: "Dominos", isDominoOrder: true, typeAgnostic: true, desc: "Prolongez la chaîne : chaque domino doit se connecter à une extrémité. 3 vies." },
    escalier: { name: "L'Escalier", isEscalier: true, typeAgnostic: true, desc: "Bâtissez un escalier de 8 marches toujours plus hautes en piochant au marché. 3 défausses permises." },
    tubes: { name: "Les Tubes", isTubes: true, typeAgnostic: true, desc: "Reversez les jetons pour reconstituer trois piles parfaitement ordonnées." },
    swapSort: { name: "Échange Minimal", isSwapSort: true, typeAgnostic: true, desc: "Remettez la rangée en ordre en échangeant deux voisins à la fois — sans dépasser le budget." },
    boulons: { name: "Les Boulons", isBoulons: true, typeAgnostic: true, desc: "Réempilez les écrous du plus large au plus fin sur chaque vis." },
    ...
    futoshiki: { name: "Plus Petit, Plus Grand", isFutoshiki: true, typeAgnostic: true, desc: "Remplissez la grille : chaque ligne et colonne contient 1-2-3-4, en respectant les signes. 2 vies." },
