...
const GAME_MODES = {
    ...
    escalier: { name: "L'Escalier", isEscalier: true, typeAgnostic: true, desc: "Bâtissez un escalier de 8 marches toujours plus hautes en piochant au marché. 2 défausses permises." },
