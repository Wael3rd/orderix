...
const GAME_MODES = {
    ...
    solitaire: { rev: 3, name: "Le Solitaire", isSolitaire: true, typeAgnostic: true, desc: "Un vrai solitaire : GLISSEZ les cartes (couleurs alternées), double-tap pour envoyer à la fondation, et seule un 10 ouvre une colonne vide. Donne toujours gagnable, annulation illimitée." },
    blocs: { rev: 4, name: "Blocs", isBlocs: true, typeAgnostic: true, desc: "GLISSEZ les pièces sur la grille : chaque ligne ou colonne complète s'efface. Effacez 6 lignes sans saturer la grille !" },
