...
const GAME_MODES = {
    ...
    paires: { name: "Paires Reliées", isPaires: true, typeAgnostic: true, desc: "Reliez les deux tuiles de même numéro par un chemin d'au plus 2 virages — et dans l'ordre : les 1, puis les 2… Le tour du plateau compte comme passage." },
